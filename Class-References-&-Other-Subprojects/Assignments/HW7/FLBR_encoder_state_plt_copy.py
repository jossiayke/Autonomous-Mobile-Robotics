...
encoder_states = np.genfromtxt("d:\\Documents\\UMD_Docs\\Grad-school\\ENPM701\\HW7\\FLBR_right_encoder_states.txt", dtype=str)
...
plt.savefig('FLBR-right-path-encoder-state-plot.png')
plt.show()
plt.close()
